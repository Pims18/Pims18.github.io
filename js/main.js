; (function ($) {
    ...
    $(document).on('ready', function () {
        ...
        var textOne = "Je suis, Développeur WEB/MOBILE.",
            textTwo = "Travaillant avec les dernières technologies.",
            textThree = "Je suis disponible pour travailler avec vous.";
